        ...
        <div id="wd-people-table">
            <Table striped>
                ...
                <tr>
                    ...
                    <td className="wd-login-id">001234523F</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2020-09-29</td>
                    <td className="wd-total-activity">04:03:31</td>
                </tr>
                <tr>
                    <td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary"/>
                    ...
                    <td className="wd-login-id">001234123L</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2020-10-01</td>
                ...
                <tr>
                    ...
                    <td className="wd-login-id">001234121J</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">TA</td>
                    <td className="wd-last-activity">2020-10-02</td>
                    <td className="wd-total-activity">11:22:47</td>
                </tr>
                </tbody>
            </Table>
        </div>);
